...
public class ValidateUtils {
  ...
  public static boolean isEmptyData(Object ob) {
    if (ob == null || "".equals(ob.toString())) return true;
    return false;
  }
  ...
  public static boolean isEmptyData(List<?> ob) {
    if (ob == null || ob.size() == 0) return true;
    return false;
  }
   ...
   * @return
   */
  public static boolean isValidStringMaxLength(
    Object value,
    Integer maxLength
  ) {
   ...
   */
  public static boolean isValidStringEnum(
    Object value,
    List<Object> valueEnum
  ) {
   ...
   * @return				Valid: true, Invalid: false
   */
  public static boolean isValidArrayStringMaxLength(
    Object value,
    Integer maxLength
  ) {
   ...
   * @return				Valid: true, Invalid: false
   */
  public static boolean isValidArrayStringEnum(
    Object value,
    List<Object> valueEnum
  ) {
    if (!isArrayStringObject(value)) {
